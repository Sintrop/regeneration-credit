...
contract("ValidatorContract", (accounts) => {
  ...
  beforeEach(async () => {
    ...
    validatorPool = await ValidatorPool.new(rcToken.address, args.halving, args.totalEras, args.blocksPerEra);
    ...
    await rcToken.addContractPool(validatorPool.address, args.totalTokens);
