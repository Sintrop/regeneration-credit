          ...
          context("when is era 2", () => {
            context("when dont have withdraw from era 1", () => {
              ...
              context("when activist1 withdraw from era 1 and era 2", () => {
                ...
                it("activist1 balance must be 1250000000000000000000000", async () => {
                  const balanceOf = await regenerationCredit.balanceOf(activist1Address);

                  expect(balanceOf).to.equal(1250000000000000000000000n);
                });

                it("activist1 balance in era 1 must be 625000000000000000000000", async () => {
                  const balanceOf = await instance.eraTokens(1, activist1Address);

                  expect(balanceOf).to.equal(625000000000000000000000n);
                });

                it("activist1 balance in era 2 must be 625000000000000000000000", async () => {
              ...
              context("when activist2 withdraw from era 1 and era 2", () => {
                ...
                it("activist2 balance must be 1250000000000000000000000", async () => {
                  const balanceOf = await regenerationCredit.balanceOf(activist2Address);

                  expect(balanceOf).to.equal(1250000000000000000000000n);
                });

                it("activist2 balance in era 1 must be 625000000000000000000000", async () => {
                  const balanceOf = await instance.eraTokens(1, activist2Address);

                  expect(balanceOf).to.equal(625000000000000000000000n);
                });

                it("activist2 balance in era 2 must be 625000000000000000000000", async () => {
