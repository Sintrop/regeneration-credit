...
describe("ContributorContract", (accounts) => {
  ...
  beforeEach(async () => {
    ...
    await rcToken.addContractPool(contributorPool.target, "30000000000000000000000000");
    ...
    context("when is invited", () => {
      context("when contributor exists", () => {
        it("should return error message", async () => {
          ...
          await expect(addContributor("Contributor A", contr1Address)).to.be.revertedWith("This contributor already exist");
        });
      });
