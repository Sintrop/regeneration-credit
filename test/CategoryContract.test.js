...
contract("CategoryContract", (accounts) => {
  ...
  context("When access category fields", () => {
    it("should have fields", async () => {
      ...
      assert.equal(category.tutorial, `Aqui deve ser descrito como ativistas devem avaliar o ${name}`)
  ...
  context("When will vote category", () => {
    ...
    it("should return error when try to vote more than 100k tokens", async () => {
    ...
    it("should subtract tokensfrom user after vote in a category", async () => {
      await addCategory("Solo", resea1Address);
      await transferTokensTo(user1Address, "50000000000000000000000");
    ...
    context("When user dont have tokens", () => {
    ...
    context("When user dont send tokens", () => {
    ...
    context("When user try to unvote", () => {
  ...
  context("When call getCategories", () => {
