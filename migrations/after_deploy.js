...
async function configureValidatorRules() {
  ...
  await validatorRules.setContractAddressDependencies(contractDependencies);
...
async function configureInspectionRules() {
  ...
  await userRules.newAllowedCaller(inspectionRules.target);
  await validatorRules.newAllowedCaller(inspectionRules.target);
...
async function addCategories() {
  ...
  await regenerationIndexRules.addCategory("Carbon", "Indicator to measure CO2 balance. Must evaluate carbon emissions and sequestration. Carbon balance = sequestration - emissions [tCO2]", [
    {
  ...
  await regenerationIndexRules.addCategory("Soil", "Indicator to measure impact of soil. Balance = regenerating soil - degradation soil [ha]", [
    {
      regenerationIndexId: 1, 
  ...
  await regenerationIndexRules.addCategory("Water", "Indicator to measure water balance. Balance = vegetation water impact + self harvest water - used water [m3]", [
    {
      regenerationIndexId: 1, 
      description: "Balance > 100.000"
    },
  ...
  await regenerationIndexRules.addCategory("Biodiversity", "Indicator to measure the level of plant and animal biodiversity. Our unit is 'unit of life', meaning one species of fauna and flora. Balance = ul restored - ul destroyed. [ul].", [
    {
      regenerationIndexId: 1, 
      description: "Balance > 1000"
    },
