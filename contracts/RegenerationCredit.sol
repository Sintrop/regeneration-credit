 ...
 */
contract RegenerationCredit is ERC20, ERC20Permit, Ownable, ReentrancyGuard {
   ...
   */
  constructor(uint256 totalSupply) ERC20(NAME, SYMBOL) ERC20Permit(NAME) Ownable(msg.sender) {
